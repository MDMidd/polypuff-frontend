    ...
    <ScreenBackground style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        ...
        <Section title={wt('account')} icon={<User size={18} color={C.cyan || '#00E5FF'} />}>
          ...
          <Row
            label="Email Learning Reminders"
            ...
            right={
              <Switch
                ...
                accessibilityLabel="Email learning reminders"
                accessibilityState={{ checked: emailReminderEnabled, disabled: !accountToken || emailReminderLoading }}
              />
            }
            accessibilityLabel={`Email learning reminders are ${emailReminderEnabled ? 'on' : 'off'}`}
          />
          <Row
          ...
          {canChangePassword && (
            <Row
              ...
              right={resettingPassword
                ? <Text style={{ fontSize: scaledFont(13), color: C.textMuted }}>Sending...</Text>
        ...
        <Section title="Billing" icon={<CreditCard size={18} color={C.emerald || '#00E5A0'} />}>
          <Row
            ...
            right={openingBilling
              ? <Text style={{ fontSize: scaledFont(13), color: C.textMuted }}>Opening...</Text>
          ...
          <Row
            ...
            accessibilityLabel="View 7-day money-back guarantee. Opens external link."
          />
        </Section>
        ...
        <Section title={t.practice} icon={<Text style={{ fontSize: 18 }}>✏️</Text>}>
          <Row
            ...
            accessibilityLabel="Customise your practice list — choose exercises and reorder them"
            accessibilityHint="Opens the Practice List customiser"
          />
        </Section>

        <Section title="Backend" icon={<Server size={18} color={C.cyan || '#00E5FF'} />}>
          <Row
          ...
          <View style={{ paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 1, borderTopColor: C.border + '10' }}>
            <TextInput
              ...
              autoCorrect={false}
              keyboardType="url"
              accessibilityLabel="Custom backend server URL"
            />
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel="Save and test custom backend URL"
            >
              <Text style={{ fontSize: scaledFont(14), fontWeight: '700', color: '#07111F' }}>Save & Test</Text>
            </TouchableOpacity>
          </View>
          <Row
            ...
            accessibilityLabel="Use local desktop backend"
          />
          <Row
            ...
            right={<ChevronRight size={16} color={C.textMuted} />}
            accessibilityLabel="Use Android emulator backend"
          />
          <Row
            ...
            right={<ChevronRight size={16} color={C.textMuted} />}
            accessibilityLabel="Use production backend"
          />
          <Row
          ...
          <Row
            ...
            right={
              <Switch
                ...
                accessibilityRole="switch"
                accessibilityLabel="Show Poly-Puff mascot"
        ...
        {/* ── STREAK REMINDERS ─────────────────────────────────────────── */}
        <Section title="Streak Reminders" icon={<Bell size={18} color={C.purple || '#B06CFF'} />}>
          <Row
        ...
        <Section title="Data Management" icon={<Shield size={18} color={C.red} />}>
          <Row label="Set to Default" desc="Resets language, CEFR level, and UI preferences to their defaults. Your account, progress, vaults, and bookmarks are kept."
            ...
            accessibilityLabel="Set settings to default"
          ...
          <Row label="Reset Onboarding" desc="Show the welcome walkthrough again"
            ...
            accessibilityLabel="Reset onboarding walkthrough" />
          <Row label="Clear Profile Info" desc="Remove name, profession, hobbies, photo"
            ...
            accessibilityLabel="Clear profile information. Language and level will be kept." />
          <Row label="Clear All Progress" desc="Delete exercise history, XP, badges, and streaks"
            ...
            accessibilityLabel="Clear all progress permanently. This cannot be undone."
        ...
        <Section title={wt('help')} icon={<HelpCircle size={18} color={C.cyan || '#00E5FF'} />}>
          ...
          <Row label="Terms of Service" desc="Read Poly-Puff terms"
            ...
            right={<ExternalLink size={16} color={C.textMuted} />}
            accessibilityLabel="View terms of service. Opens external link." />
        ...
        <Section title={wt('account')} icon={<Trash2 size={18} color={C.red || '#FF4D6A'} />}>
          <Row
            ...
            danger
            accessibilityLabel="Delete all my data permanently. This action cannot be undone."
        ...
        <Section title={wt('nav-about')} icon={<Info size={18} color={C.textSec} />}>
          <Row label="App Version" right={<Text style={{ fontSize: scaledFont(14), color: C.textMuted }}>{appVersion}</Text>}
            accessibilityLabel={`App version ${appVersion}`} />
          <Row label="Backend Version" right={<Text style={{ fontSize: scaledFont(14), color: C.textMuted }}>{backendVersion}</Text>}
          ...
          <Row label="CEFR Levels" right={<Text style={{ fontSize: scaledFont(14), color: C.textMuted }}>A0 – C2</Text>}
            accessibilityLabel="CEFR levels A0 through C2" />
        </Section>
        ...
        <TouchableOpacity style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' }} activeOpacity={1} onPress={() => setShowTimePicker(false)}>
          <View style={{ backgroundColor: C.card, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40, maxHeight: '60%' }}
            ...
            <Text style={{ fontSize: scaledFont(18), fontWeight: '800', color: C.text, marginBottom: 16, textAlign: 'center' }}
              accessibilityRole="header">Choose Reminder Time</Text>
            <ScrollView showsVerticalScrollIndicator={false}>
