    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'} keyboardVerticalOffset={Platform.OS === 'ios' ? 90 : 0}>
      ...
      <View style={{
        ...
        <TouchableOpacity
          ...
          accessibilityHint="Opens language and level settings"
        >
      ...
      <ScrollView ref={scrollRef} style={s.scrollView} contentContainerStyle={s.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        {!sessionPaused && (<>
          ...
          <View style={s.lengthRow}>
            <Text style={s.lengthLabel} accessibilityRole="header">Sentence Length</Text>
          ...
          <TextInput
            style={s.customInput}
            placeholder="Custom request... (e.g., 'Past tense about food')"
            placeholderTextColor={C.textMuted}
            value={customRequest}
            onChangeText={setCustomRequest}
            accessibilityLabel="Custom topic request"
          ...
          <NeonButton
            ...
            accessibilityHint={sessionActive ? 'Generates a new sentence to translate' : 'Starts a new translation practice session'}
          >
            {null}
          </NeonButton>
            ...
            <GlassCard intensity="medium" style={{ marginBottom: 16 }} borderColor={C.border + '20'} glowColor={C.purple + '10'}>
              ...
              <View style={s.topicBadge}>
                {isRetryMode && (
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4,
                    ...
                    accessibilityLabel="Retry sentence. You struggled with this one before."
                  >
              ...
              <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 8 }}>
                ...
                <TextInput
                  ...
                  accessibilityHint="Type your translation of the sentence above"
                />
                ...
                {!result && !speechSupported && (
                  <View
                    ...
                    accessibilityLabel="Voice input not available for your language"
                  >
                ...
                <View style={{ flexDirection: 'row', gap: 8, marginBottom: 10 }}>
                  ...
                  {!hintUsed ? (
                    <TouchableOpacity
                      ...
                      accessibilityHint="Reveals a clue. Caps your score at 80."
                    >
                      <Text style={{ fontSize: 14 }}>💡</Text>
              ...
              {!result && (
                <NeonButton
                  ...
                  accessibilityHint="Submits your translation for scoring"
                >
                  {null}
                </NeonButton>
              )}
            ...
            <View accessibilityLiveRegion="polite">
              ...
              {(correctTranslation || result.correctAnswer) && (
                ...
                >
                  ...
                  <Text style={{ fontSize: scaledFont(11), color: C.textMuted }}>Tap ›</Text>
                </TouchableOpacity>
              )}
      ...
      <Modal visible={showChat} animationType="slide" onRequestClose={() => setShowChat(false)}>
        ...
        <View style={s.chatScreen} accessibilityViewIsModal={true}>
          <View style={s.chatHeader}>
            <Text style={s.chatHeaderTitle} accessibilityRole="header">Poly-Puff</Text>
            {/* ✅ A11Y: Close button */}
            <TouchableOpacity
          ...
          <ScrollView style={s.chatMessages} contentContainerStyle={{ padding: 16, gap: 12 }}>
            ...
            <View style={s.chatBubbleA} accessibilityRole="text" accessibilityLabel="Poly-Puff, AI response: Hi! I can help explain grammar rules. What would you like to know?">
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 4 }}>
                ...
                <Text style={{ fontSize: 10, fontWeight: '700', color: C.purple || '#8B5CF6' }}>Poly-Puff</Text>
              </View>
              <Text style={s.chatBubbleText}>Hi! I can help explain grammar rules. What would you like to know?</Text>
            </View>
            {chatMessages.map((msg, i) => (
              <View
                ...
                accessibilityRole="text"
                accessibilityLabel={msg.role === 'user' ? `You said: ${msg.text}` : `Poly-Puff, AI response: ${msg.text}`}
              >
            ...
            {chatLoading && (
              <View style={s.chatBubbleA} accessibilityLabel="Poly-Puff is typing">
          ...
          <View style={s.chatInputRow}>
            ...
            <TextInput
              ...
              accessibilityLabel="Ask Poly-Puff a grammar question"
            />
            {/* ✅ A11Y: Send button */}
            <TouchableOpacity
              style={s.chatSendBtn}
